...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE firasf_catalog.dbt.dbt_c360_gold_churn_predictions
# MAGIC AS 
# MAGIC SELECT predict_churn(struct(user_id, age_group, canal, country, gender, order_count, total_amount, total_item, platform, event_count, session_count, days_since_creation, days_since_last_activity, days_last_event)) as churn_prediction, * FROM firasf_catalog.dbt.dbt_c360_gold_churn_features
...
# MAGIC FROM firasf_catalog.dbt.dbt_c360_gold_churn_predictions
# MAGIC LIMIT 10;
